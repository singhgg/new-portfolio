...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Marcamor Consulting Pvt. Ltd.",
    description: [
      "Developed and maintained real-world client websites.",
      "Built responsive and user-friendly frontend interfaces.",
      "Worked on website improvements and optimization.",
    ],
    skills: [],
  },
  {
    ...
    endDate: "August 2025",
    title: "AI Intern",
    company: "Swetcha Vishwam AI",
    description: [
      "Worked on AI-focused projects and applications.",
      "Assisted with implementing and testing AI-based solutions.",
      "Gained practical experience in AI development and related technologies.",
    ],
    skills: [],
  },
  {
    ...
    title: "Website Data Input Specialist",
    company: "Quantuva Technologies",
    description: [
      "Managed and entered website-related data accurately.",
      "Maintained data quality and consistency across web platforms.",
      "Assisted with website content and data management tasks.",
    ],
    skills: [],
  },
];
