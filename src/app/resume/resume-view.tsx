...
// Drop the compiled PDF here: frontend/public/Dhanwanth_Singh_Professional_Resume_New.pdf
const RESUME_PATH = "/Dhanwanth_Singh_Professional_Resume_New.pdf";
